function bidderEmailVerificationTemplate (verificationCode, email) {
    ...
    return '<table width="100%" height="100%" cellpadding="0" cellspacing="0" border="0" style="font-size:14px;font-family:Microsoft Yahei,Arial,Helvetica,sans-serif;padding:0;margin:0;color:#333;background-color:#f7f7f7;background-repeat:repeat-x;background-position:bottom left">\n' +
        ...
        '\t<tbody><tr>\n' +
        '\t\t<td>Confirm <span class="il">Your</span> Registration</td>\n' +
        '\t\t<td>\n' +
        '\n' +
        '\t\t</td>\n' +
        '\t\t</tr>\n' +
        ...
        '</tr>\n' +
        '<tr>\n' +
        '<td style="font-size:14px;line-height:30px;padding:20px 0;color:#666">Welcome to iNegotio!<br>Click the button below to <span class="il">complete</span> verification:</td>\n' +
        '</tr>\n' +
        '<tr>\n' +
        '<td style="padding:5px 0"><a href="https://www.inegotio.com/verify-intermediate/email/'+email+'/token/'+verificationCode+'" style="padding:10px 28px;background:#5165a9;color:#fff;text-decoration:none" target="_blank">Verify Email</a></td>\n' +
        '</tr>\n' +
        '<tr>\n' +
        '\n' +
...
export = { bidderEmailVerification: bidderEmailVerificationTemplate };