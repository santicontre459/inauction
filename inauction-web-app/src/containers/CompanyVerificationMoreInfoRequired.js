...
const CompanyVerificationMoreInfoRequired = () => {
  return (
    <Layout className="gx-app-layout not-logged-in-routes-layout">
      <Helmet>
        <title>Company Verification More Info Required - iNauction Tool | Procurement Platform</title>
      </Helmet>
        ...
        <div className="gx-app-login-container gx-host-form-register">
          <div className="gx-app-login-main-content">
            <div className="gx-app-register-content app-register-form">
              <div className="gx-app-message-content company-verification-more-info-required">
                <div className="gx-app-logo-wid">
                  <div className="icon icon-exclamation" />
                  <h3><IntlMessages id="app.userAuth.company.verification.moreInfo.title"/></h3>
                  <h4><IntlMessages id="app.userAuth.company.verification.moreInfo.subtitle"/></h4>
                  <h5 className="light_gray"><IntlMessages id="app.userAuth.company.verification.moreInfo.label1"/><br/>
                    <IntlMessages id="app.userAuth.company.verification.moreInfo.label2"/>
                  </h5>
                </div>
              </div>
              <Divider />
...
export default CompanyVerificationMoreInfoRequired;
