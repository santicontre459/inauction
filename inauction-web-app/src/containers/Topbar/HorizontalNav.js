  ...
  render() {
    ...
    return (
      ...
      <Menu
        ...
        <SubMenu className={this.getNavStyleSubMenuClass(navStyle)} key="super-admin-configurations"
                 title={<IntlMessages id="sidebar.superAdminConfigurations"/>}>


          <Menu.Item key="super-admin-configurations/categories">
            <Link to="/super-admin-configurations/categories">
              <i className="icon icon-copy"/>
        ...
        <SubMenu className={this.getNavStyleSubMenuClass(navStyle)} key="custom-views"
          ...
          <SubMenu className="gx-menu-horizontal" key="user-auth"
            ...
            <Menu.Item key="custom-views/user-auth/change-password">
              <Link to="/custom-views/user-auth/change-password">
                <IntlMessages
