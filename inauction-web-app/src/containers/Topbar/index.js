...
import {switchLanguage, toggleCollapsedSideNav} from "../../iNRedux/actions/Setting";
import SearchBox from "components/SearchBox";
import UserInfo from "components/UserInfo";
import AppNotification from "../../components/AppNotification/indexPopUp";
          ...
          <ul className="gx-header-notifications gx-ml-auto">
            <li className="gx-notify gx-notify-search gx-d-inline-block gx-d-lg-none">
              <Popover overlayClassName="gx-popover-horizantal" placement="bottomRight" content={
                ...
                <span  className="gx-pointer gx-d-block"><i  className="icon icon-ckeditor"/></span>
              </Popover>
            </li>
            {width >= TAB_SIZE ? null :
              <Auxiliary>
