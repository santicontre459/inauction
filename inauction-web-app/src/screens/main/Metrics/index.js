...
import EcommerceStatus from "./components/EcommerceStatus";
import TrafficRaiseCard from "./components/TrafficRaiseCard";
import TotalEncomeCard from "./components/TotalEncomeCard";
          ...
          <ChartCard title="44" children={
            <ResponsiveContainer width="100%" height={75}>
              <LineChart data={lineData2}
                ...
                <Tooltip/>
                <Line dataKey="traffic" stroke="#3f869c" dot={{stroke: '#FEA931', strokeWidth: 2}}/>
              </LineChart>
