...
const InGrowthCard = ({trafficData}) => {
  return (
    <Metrics styleName={`gx-card-full`} title={<IntlMessages id="user.dashboard.growth" />}>
      <Row gutter={[16, 0]}>
        <Col lg={9} md={24} sm={9} xs={9}>
          <div className="gx-pb-4 gx-pl-4 gx-pt-4">
            ...
            <p className="gx-mb-0 gx-text-grey"><IntlMessages id="user.dashboard.growth.this_year" /></p>
          </div>
        </Col>
