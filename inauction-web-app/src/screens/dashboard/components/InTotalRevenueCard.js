...
import Metrics from "../../main/Metrics/components";
import { connect } from "react-redux";
import { readableTranslateString } from "../../../util/readableTranslateString";
...
const InTotalRevenueCard = ({width}) => {
  return (
    <Metrics title={readableTranslateString("user.dashboard.total_revenue")}>
      <Row gutter={[16, 0]}>
        ...
        <Col xl={13} lg={12} md={24} sm={12} xs={12}>
          <ResponsiveContainer className="gx-barchart" width="100%" height={70}>
            <BarChart
              ...
              <Tooltip/>
              <Bar dataKey="lastYear" stackId="a" fill="#3f869c" barSize={width <= 575 ? 4 : 8}/>
...
export default connect(mapStateToProps)(InTotalRevenueCard);
