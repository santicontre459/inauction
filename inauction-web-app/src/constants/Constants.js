...
export const weightingOptions = [
    {label: "No", value: 0},
    {label: "Weighting per Question", value: 'PER_QUESTION'},
    {label: "Weighting per Section", value: 'PER_SECTION'},
    {label: "Weighting per  Section & Question", value: 'PER_SECTION_AND_QUESTION'}
];
